<ADSWorkspace Revision="4" Version="100">
    <Workspace Name="">
        ...
        <Library Name="mlab_project2_lib" />
        <ConfigFile Name="dds.cfg" />
        <Data_Display Name="wilkinson_schematic.dds" />
        <Log Name="netlist.log" />
        <Log Name="search_history.log" />
        <Preferences Name="ads_builtin_lay.prf" />
        <Preferences Name="mlab_project2_lib_lay.prf" />
        <Preferences Name="mlab_project2_lib_sch.prf" />
        <Dataset Name="wilkinson_schematic.ds" />
        <Data_Files Name="wilkinson_schematic.ds" />
        <Data_Files Name="wilkinson_schematic_data\logFile.txt" />
        <Substrate Name="mlab_project2_lib:tech.subst" />
        <Cell Name="mlab_project2_lib:wilkinson_schematic" />
        <Layer_Preference Name="mlab_project2_lib.layerprf" />
        <Cell Name="mlab_project2_lib:wilkinson" />
